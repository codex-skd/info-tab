...
| `minecraft/26.1.2/neoforge-26.1.2.76/production` | Rama de trabajo. Contiene todo el proyecto (código + docs/ + lib_ext/ + graphify-out/ + tokens reales) |
| `minecraft/26.1.2/neoforge-26.1.2.76/main` | Rama pública para mirror a GitHub. Solo contiene código fuente compilable. Se actualiza automáticamente vía CI/CD desde su hermana production |
...
2. Añadir `https://<token>@github.com/tuusuario/dimension-tab.git`
3. Dirección: **Push**
