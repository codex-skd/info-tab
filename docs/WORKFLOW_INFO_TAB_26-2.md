...
> Este archivo pertenece al proyecto **Info TAB**. Cambios aquí solo afectan a este proyecto.
...
| Dato | Valor |
|---|---|
| Mod ID (`gradle.properties`) | `info_tab` |
| Clase principal | `InfoTab` |
| Display name (Title Case) | `Info TAB` |
| Versiones de Minecraft | `26.1.2 y 26.2` |
| Última versión publicada | `1.0.3` (CurseForge file ID 8677464) |
...
|---|---|---|
| **snake_case** | `mod_id`, assets/, packages Java | `info_tab` |
| **PascalCase** | Clases Java principales | `InfoTab` |
| **camelCase** | Variables, métodos, config keys | `info_tabConfig` |
| **Title Case** | Display name (README, CHANGELOG, docs, CurseForge) | `Info TAB` |
