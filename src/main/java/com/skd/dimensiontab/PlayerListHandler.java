...
public abstract class PlayerListHandler {
    ...
    public static net.minecraft.network.chat.TextColor parseColor(String colorStr) {
        if (colorStr == null || colorStr.isEmpty()) {
            return net.minecraft.network.chat.TextColor.fromLegacyFormat(ChatFormatting.GOLD);
        }

        ChatFormatting formatting = ChatFormatting.getByName(colorStr.toLowerCase());
        if (formatting != null && formatting.getColor() != null) {
            return net.minecraft.network.chat.TextColor.fromLegacyFormat(formatting);
        }

        if (colorStr.startsWith("#")) {
            return net.minecraft.network.chat.TextColor.parseColor(colorStr).result()
                    .orElse(net.minecraft.network.chat.TextColor.fromLegacyFormat(ChatFormatting.GOLD));
        }
