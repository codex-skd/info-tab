...
public abstract class PlayerListHandler {
    ...
    private String resolveDimensionColor(ResourceLocation dimension, String color) {
    ...
    private MutableComponent extractTokensFromFormat(Player player, ResourceLocation dimension) {
    ...
    private String resolveTokenValue(String tokenType, ResourceLocation dimension) {
